    ...
    return (
            <section className="agk-hero">
                <div className="hero-wrapper-three">
                    ...
                    <Image src="/assets/images/marketing-agency/hero/hero-img.jpg" alt="img" width={1815} height={658}   />
                        ...
                        <div className="text-box">
                            <p>Kneoxt helps <span>startups and growing teams</span> build powerful digital products — from websites and mobile apps to custom software — and grow with confidence through smart development, thoughtful design, and hands-on marketing support.</p>
                        </div>
                    </div>
                </div>
            </section>
